// Package netaddr provides conversions between netaddr.Addr and Sockaddr
package netaddr
...
// NetAddrAF returns the unix AF_* type for a given netaddr.Addr
...
// NetAddrIPPROTO returns the unix IPPROTO_* type for a given netaddr.Addr
...
// NetAddrSOCK returns the unix SOCK_* type for a given netaddr.Addr
...
// NetAddrToSockaddr converts a netaddr.Addr to a Sockaddr.
...
// IPAndZoneToSockaddr converts a netaddr.IP (with optional IPv6 Zone) to a Sockaddr
...
// IPAddrToSockaddr converts a netaddr.IPAddr to a Sockaddr.
// Returns nil if conversion fails.
func IPAddrToSockaddr(addr *net.IPAddr) Sockaddr {
	return IPAndZoneToSockaddr(addr.IP, addr.Zone)
}

// TCPAddrToSockaddr converts a netaddr.TCPAddr to a Sockaddr.
// Returns nil if conversion fails.
...
// UDPAddrToSockaddr converts a netaddr.UDPAddr to a Sockaddr.
// Returns nil if conversion fails.
...
// UnixAddrToSockaddr converts a netaddr.UnixAddr to a Sockaddr, and returns
...
// SockaddrToIPAndZone converts a Sockaddr to a netaddr.IP (with optional IPv6 Zone)
// Returns nil if conversion fails.
...
// SockaddrToIPAddr converts a Sockaddr to a netaddr.IPAddr
// Returns nil if conversion fails.
...
// SockaddrToTCPAddr converts a Sockaddr to a netaddr.TCPAddr
// Returns nil if conversion fails.
...
// SockaddrToUDPAddr converts a Sockaddr to a netaddr.UDPAddr
// Returns nil if conversion fails.
...
// from: go/src/pkg/netaddr/unixsock_posix.go

// SockaddrToUnixAddr converts a Sockaddr to a netaddr.UnixAddr
// Returns nil if conversion fails.
...
// SockaddrToUnixgramAddr converts a Sockaddr to a netaddr.UnixAddr
// Returns nil if conversion fails.
...
// SockaddrToUnixpacketAddr converts a Sockaddr to a netaddr.UnixAddr
// Returns nil if conversion fails.
...
// from: go/src/pkg/netaddr/ipsock.go

// IP6ZoneToString converts an IP6 Zone unix int to a netaddr string
...
// IP6ZoneToInt converts an IP6 Zone netaddr string to a unix int
...
// from: go/src/pkg/netaddr/parse.go
